...
import * as Snapshot$dAddPre from "../Snapshot.AddPre/index.js";
const addPreLazy = dictShow => dictMonadAff => dictFoldable => dictMonadAff.liftAff(Effect$dAff._bind(Effect$dAff._liftEffect(DynamicImport.dynamicImport(Snapshot$dAddPre.addPre(dictShow)(dictFoldable))))(Control$dPromise.toAff$p(Control$dPromise.coerce)));
const main = /* #__PURE__ */ (() => {
